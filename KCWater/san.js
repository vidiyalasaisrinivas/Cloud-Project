...
app.controller('MainCtrl',function ($scope,$http) {
    ...
    $http.get("\n" +
        "https://data.kcmo.org/resource/cyqf-nban.json?department=Water%20Services&creation_year=2016&$select=count(case_id),creation_month&$order=count(case_id)%20DESC&$group=creation_month&$LIMIT=12").then(function (value) {
